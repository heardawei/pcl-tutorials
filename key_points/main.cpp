...
// void
// setViewerPose (pcl::visualization::PCLVisualizer& viewer, const
// Eigen::Affine3f& viewer_pose)
//{
// Eigen::Vector3f pos_vector = viewer_pose * Eigen::Vector3f (0, 0, 0);
// Eigen::Vector3f look_at_vector = viewer_pose.rotation () * Eigen::Vector3f
// (0, 0, 1) + pos_vector; Eigen::Vector3f up_vector = viewer_pose.rotation () *
// Eigen::Vector3f (0, -1, 0); viewer.setCameraPosition (pos_vector[0],
// pos_vector[1], pos_vector[2], look_at_vector[0], look_at_vector[1],
...
int main(int argc, char **argv) {
  ...
  // true; narf_keypoint_detector.getParameters ().distance_for_additional_points
  // = 0.5;
